		...
		<nav class="navbar navbar-default w3ls navbar-fixed-top">
			<div class="container">
				<div class="navbar-header wthree nav_2">
					...
					<a class="navbar-brand agileinfo" href="${pageContext.request.contextPath }/baohiem/index.html"><span><m:message code="logoleft"></m:message></span> <m:message code="logoright"></m:message></a> 
				</div>
		...
		<div class="agileheader-topbar">
			<div class="container">
				<div class="col-md-2 agileheader-topbar-grid agileheader-topbar-grid1">
                    ...
                    <a href="${pageContext.request.contextPath }/baohiem/index.html?lang=vi" style="color: #C41228">Tiếng việt |</a>
					<a href="${pageContext.request.contextPath }/baohiem/index.html?lang=en" style="color: #C41228">English</a>
                </div>
                <div class="col-md-2 agileheader-topbar-grid agileheader-topbar-grid1">
