...
<script src="${pageContext.request.contextPath }/js/modernizr.custom.js"></script>
    ...
    <!-- //cart-js --> 
        ...
        <!-- Header-Slider-JavaScript-Files -->
            ...
            <script type='text/javascript' src='${pageContext.request.contextPath }/js/fluid_dg.min.js'></script>
        ...
        <!-- Model-Slider-JavaScript-Files -->
            <script src="${pageContext.request.contextPath }/js/jquery.film_roll.js"></script>
            <script>
                (function() {
                    jQuery(function() {
    ...
    <!-- //Custom-JavaScript-File-Links -->
        ...
        <!-- Bootstrap-JavaScript --> <script src="${pageContext.request.contextPath }/js/bootstrap.js"></script>
</body>
</html>