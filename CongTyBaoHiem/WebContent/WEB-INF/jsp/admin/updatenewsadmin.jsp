...
<script type="text/javascript">
	...
	function CheckValidateUpdateNews(){
	...
	<div id="content">
		<div id="content-header">
			<div id="breadcrumb">
				...
				<a href="#" class="current">Cập nhật tin tức</a>
			</div>
		</div>
				...
				<div class="span6">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<s:form method="post" commandName="tintuc" action="${pageContext.request.contextPath }/baohiem/updatenewsadmin.html" class="form-horizontal">
								...
								<div class="form-actions" style="text-align: center;">
									...
									<button type="submit" class="btn btn-success" onclick="return CheckValidateUpdateNews();">Cập nhật</button>
								</div>
							</s:form>
						</div>
					</div>
