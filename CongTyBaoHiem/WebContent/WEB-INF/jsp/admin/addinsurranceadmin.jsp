...
<script type="text/javascript">
	...
	function CheckValidateAddInsurrance(){
	...
	<div id="content">
		<div id="content-header">
			<div id="breadcrumb">
				...
				<a href="${pageContext.request.contextPath }/baohiem/addinsurranceadmin.html" class="current">Thêm mới bảo hiểm</a>
			</div>
		</div>
				...
				<div class="span6">
					<div class="widget-box">
						<div class="widget-title">
							...
							<h5>Thêm mới bảo hiểm</h5>
						</div>
						<div class="widget-content nopadding">
							<s:form method="post" commandName="baohiem" action="${pageContext.request.contextPath }/baohiem/addinsurranceadmin.html" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<s:input path="dongia" id="dongia" name="dongia" type="number" step="100000" min="100000" max="1000000000" class="span11" value="1000000" />
									</div>
								</div>
								<div class="control-group">
								...
								<div class="form-actions" style="text-align: center;">
									...
									<button type="submit" class="btn btn-success" onclick="return CheckValidateAddInsurrance();">Thêm mới</button>
								</div>
							</s:form>
						</div>
					</div>
