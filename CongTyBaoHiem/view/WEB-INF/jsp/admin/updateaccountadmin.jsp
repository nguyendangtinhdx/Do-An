...
<script type="text/javascript">
	...
	function CheckValidateUpdateAccount(){
	...
	<div id="content">
		<div id="content-header">
			<div id="breadcrumb">
				...
				<a href="#" class="current">Cập nhật tài khoản</a>
			</div>
		</div>
				...
				<div class="span6">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<s:form method="post" commandName="taikhoan" action="${pageContext.request.contextPath }/baohiem/updateaccountadmin.html" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<s:password path="matkhau" id="matkhau" name="matkhau" class="span11" placeholder="Mật khẩu mới" />
									</div>
								</div>
								<div class="control-group">
								...
								<div class="form-actions" style="text-align: center;">
									...
									<button type="submit" class="btn btn-success" onclick="return CheckValidateUpdateAccount();">Cập nhật</button>
								</div>
							</s:form>
						</div>
					</div>
