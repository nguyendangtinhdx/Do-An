...
<!-- Default-JavaScript --><script src="${pageContext.request.contextPath }/js/jquery-2.1.4.min.js"></script>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/slide/coin-slider.js"></script>
	<link rel="stylesheet" href="${pageContext.request.contextPath }/slide/coin-slider-styles.css" type="text/css" />
</head>
