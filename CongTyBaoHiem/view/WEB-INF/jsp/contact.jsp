...
<body style="background: #F5F5F5">
    ...
    <h2 style="font-weight: bold; margin: auto; font-family: inherit;">LIÊN HỆ</h2>    
    
    <div class="wthreeaddressaits">
        <div class="container">
            <div class="col-md-6 wthreeaddressaits-grid wthreeaddressaits-grid1">
                ...
                <div class="aitsemailw3l">
                    <h4>Email</h4>
                    <ul>
                        <li><a href="mailto:mail@example.com"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> nguyendangtinhdx@gmail.com</a></li>
                    </ul>
                </div>
                <div class="clearfix"></div>
            </div>

            <div class="col-md-6 wthreeaddressaits-grid wthreeaddressaits-grid2">
                <form action="#" method="post">
                    <input type="text" class="text" name="Name" placeholder="Họ tên" required="">
                    <input type="text" class="text" name="Email" placeholder="Email" required="">
                    <input type="text" class="text" name="Phone" placeholder="Số điện thoại" required="">
                    <input type="text" class="text" name="City" placeholder="Thành phố" required="">
                    <textarea name="Message" class="text" placeholder="Nội dung" required=""></textarea>
 ...
 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3835.6710041564957!2d108.2598647142334!3d15.978548246107414!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314210f2d038af0f%3A0x51c64b1130497f99!2sFPT+Complex+Building!5e0!3m2!1svi!2s!4v1520906780346" width="100%" height="500" frameborder="0" style="border:0" allowfullscreen></iframe>
